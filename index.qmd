...
::: columns
::: {.column width="33%"}
![](0_Figures/1_ProgramacionHistoria1.jpg)
**Charles Babbage**
(Diciembre 26, 1791 - Octubre 18, 1871)
:::

::: {.column width="33%"}
![](0_Figures/1_ProgramacionHistoria2.jpg)
**Ada Lovelance**
(Diciembre 10, 1815 - Noviembre 27, 1852)
:::

::: {.column width="34%"}
![](0_Figures/1_ProgramacionHistoria3.png)
**Alan Turing**
(Junio 23, 1912 - Junio 7, 1954)
:::
:::
